...
| **SPEC-018 Composer refine (progress + temp viewer sequence):** | backend spec `@spiderfeet/.governance/specs/SPEC-018-composer-refine.md` · agent plan `@spiderfeet/.governance/project/SPEC018_AGENT_PLAN.md` · this repo's issue index `.governance/project/SPEC018_WIDGET_ISSUE_INDEX.md` · YAML `@yaml-workflow-widget/.governance/project/SPEC018_ISSUE_INDEX.md` |
| **SPEC-019 Composer refine 2 (identity / Nerva / Nuclei / collectors / domain hierarchy):** | backend spec `@spiderfeet/.governance/specs/SPEC-019-composer-refine-2.md` · agent plan `@spiderfeet/.governance/project/SPEC019_AGENT_PLAN.md` · backend index `@spiderfeet/.governance/project/SPEC019_ISSUE_INDEX.md` · YAML `@yaml-workflow-widget/.governance/project/SPEC019_ISSUE_INDEX.md` · **no host-widget issues this spec** (batch `i/n` reuses SPEC-018 B2/D1) |
