...
| File | Contents |
|------|----------|
| [multi-root-workspace.md](multi-root-workspace.md) | Workspace file format, cross-project `@` mentions |
| [monorepo-patterns.md](monorepo-patterns.md) | Monorepo layout, package rules, focused opening |
| [indexing-strategy.md](indexing-strategy.md) | `.cursorignore`, selective indexing |
| [examples.md](examples.md) | Example requests and outcomes |
